...
- Imagery: premium campaign photography with fashion, hospitality, sport, and lifestyle energy.

## Tokens

- Ink: `#202020`; stage: `#000000`; soft stage: `#0b0a0a`.
- Paper: `#f8f7f4`; champagne: `#f4c151`; pale gold: `#ffe994`.
- Rose: `#d8a09a`; deep rose: `#9b5754`; action maroon: `#8c0000`.
...
- Desktop hero uses a three-part editorial composition; tablet becomes two columns; mobile becomes a linear narrative.
